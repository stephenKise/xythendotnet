	...
	switch ($hookname){
		case "superuser":
			if ($session['user']['superuser'] & SU_EDIT_USERS){
				addnav("Statistics");
				addnav("Ban Log","runmodule.php?module=baneditor");
			}
...
function baneditor_run(){
	...
	switch ($op){
		case "":
			...
			addnav("3 weeks","runmodule.php?module=baneditor&duration=3+weeks");
			addnav("4 weeks","runmodule.php?module=baneditor&duration=4+weeks");
			addnav("2 months","runmodule.php?module=baneditor&duration=2+months");
			// addnav("3 months","runmodule.php?module=baneditor&duration=3+months");
			addnav("4 months","runmodule.php?module=baneditor&duration=4+months");
			// addnav("5 months","runmodule.php?module=baneditor&duration=5+months");
			addnav("6 months","runmodule.php?module=baneditor&duration=6+months");
			addnav("1 year","runmodule.php?module=baneditor&duration=1+year");
			addnav("2 years","runmodule.php?module=baneditor&duration=2+years");
			addnav("4 years","runmodule.php?module=baneditor&duration=4+years");
