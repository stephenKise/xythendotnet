...
$itstf = array(0=>10,1=>20,2=>45,3=>60);
$timeout_mins = $itstf[get_module_pref("stage","ignore_the_shitty_timer_functions",$session['user']['acctid'])];
if (strtotime("-".$timeout_mins." minutes") > $session['lasthit'] && $session['lasthit']>0 && $session['loggedin']){
...
if (!file_exists('game_cache'))
{
	exec('mkdir game_cache; chmod 777 game_cache');
}
