...
if ($op == "") {
	...
	for ($i=0;$i<=86400 / getsetting("daysperday",18);$i+=300){
	...
	$setup = array(
		...
		'description' => 'Description of the server., textarea',
		...
		"xythenmayor"=>"What is the account ID of the Xythen Mayor?,int",
		...
		"defaultsuperuser"=>
			...
			SU_DEVELOPER.",Developer Super Powers (special inc list; god mode; etc),".
		...
		"maxcolors"=>"Max # of color changes usable in one comment,range,5,500,1",
		"postinglimit"=>"Limit posts to let one user post only up to 50% of the last posts (else turn it off),bool",
		"breakingnews"=>"What is said in the city headlines section of the village? (Do not put bold or center tags in),textarea",
		"post_timer"=>"Deactivate the post timer?,bool",
		...
		"New Days,title",
		"daysperday"=>"Game days per calendar day,range,1,18,1",
		...
		"transferperlevel"=>"Max player can receive from a transfer (val * level),range,500,5000,5",
		"mintransferlev"=>"Min level a player (0 DK's) needs to transfer gold,range,1,5,1",
		"transferreceive"=>"Total transfers a player can receive in one day,range,1,15,1",
		"maxtransferout"=>"Amount player can transfer to others (val * level),range,500,5000,5",
		...
		*/
		...
		"su_leaderboard"=>"Hide Superusers from the Hall of Fame?,bool",
	);
