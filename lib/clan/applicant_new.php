<?php
		...
		if ($apply==1){
			...
			$result = db_query($sql);
			$e = array (translate_inline("%s`7 looks over your form but informs you that your Guild name must consist only of letters, spaces, apostrophes, or dashes.  Also, your short name can consist only of letters. She hands you a blank form."),
				translate_inline("%s`7 looks over your form but informs you that you must have at least 5 and no more than 50 characters in your Guild's name (and they must consist only of letters, spaces, apostrophes, or dashes), then hands you a blank form."),
				translate_inline("%s`7 looks over your form but informs you that you must have at least 2 and no more than 5 characters in your Guild's short name (and they must all be letters), then hands you a blank form."),
				translate_inline("%s`7 looks over your form but informs you that the Guild name %s is already taken, and hands you a blank form."),
				...
				translate_inline("%s`7 asks for the %s gold to start the Guild, but you seem to be unable to produce the fees."),
				translate_inline("%s`7 asks for the %s gold and %s gems to start the Guild, but you seem to be unable to produce the fees."),
				translate_inline("%s`7 asks for the %s gems to start the Guild, but you seem to be unable to produce the fees."),
...
/*//*/						} else {
							...
							debuglog("has started a new Guild (<$clanshort> $clanname) for $gold gold and $gems gems.");
							...
							addnav("Enter your Guild hall","clan.php");
/*//*/						}
					}
				}
			}
			...
			output("`7She tells you that there are three requirements to starting a guild. You will need to provide a name for the guild, as long as a short name that your guild members can refer by. That is...If you are willing to pay the fee...");
			output("The fees are as follows:`nGold: `^%s`7`nGems: `%%s`7",$gold,$gems);
			addnav("Return to the Lobby","clan.php");
			$e1 = translate_inline("`n`n\"`5Since you do not have enough gold with you, I cannot allow you to apply for a guild,`7\" she says.");
			$e2 = translate_inline("`n`n\"`5Since you do not have enough gems with you, I cannot allow you to apply for a guild,`7\" she says.");
