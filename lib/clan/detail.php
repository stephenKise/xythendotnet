<?php
	...
	if ($session['user']['superuser'] & SU_EDIT_COMMENTS){
		...
		$e = translate_inline("Edit Guild Info");
	...
	output("`0This is the current Guild membership of %s < %s >:`n",$row1['clanname'],$row1['clanshort']);
	page_header("Guild Membership for %s &lt;%s&gt;", full_sanitize($row1['clanname']), full_sanitize($row1['clanshort']));
