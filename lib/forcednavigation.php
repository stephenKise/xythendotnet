...
function do_forced_nav($anonymous,$overrideforced){
	...
	if (isset($session['loggedin']) && $session['loggedin']){
		...
		if (!$anonymous){
			...
			debug("TIMEOUT DEBUG: Not logged in: $REQUEST_URI");
		}
	}
}
?>
