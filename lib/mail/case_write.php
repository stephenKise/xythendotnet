...
$row="";
$eom = httpget('eom');
$yomcolor = get_module_pref("user_yomcolor","defaultcolor");
if ($yomcolor == "") $yomcolor = "`^";
...
rawoutput("<table border='0' cellpadding='0' cellspacing='0' width='100%'><tr><td><input type='submit' class='button' value='$send'></td></tr></table>");
require_once("lib/forms.php");
$realbody = $yomcolor.$body;
previewfield("body", "`^", false, false, array("type"=>"textarea", "class"=>"input", "cols"=>"60", "rows"=>"9", "onKeyDown"=>"sizeCount(this);"), htmlentities($realbody, ENT_COMPAT, getsetting("charset", "ISO-8859-1")).htmlentities(stripslashes(httpget('body')), ENT_COMPAT, getsetting("charset", "ISO-8859-1")));
