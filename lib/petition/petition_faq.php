...
output("`^Welcome to %s.`n`n",getsetting("gamename","Legend of the Green Dragon"));
...
output("The title of the pamphlet reads: `&\"Everything You Wanted to Know About %s, but Were Afraid to Ask.\"",getsetting("gameshortname","LotGD"));
