...
output("`n`n`^Welcome to the %s New Player Primer`n`n",getsetting("gamename","Legend of the Green Dragon"));
output("`^`bThe village square`b`n");
output("`@%s (%s) is turning out to be a fairly expansive game, with a lot of areas to explore.",getsetting("gamename","Legend of the Green Dragon"),getsetting("gameshortname","LotGD"));
...
output("In %s, being dead is only a temporary condition.",getsetting("gamename","Legend of the Green Dragon"));
...
if (getsetting("pvp",1)){
	...
	output("`@%s contains a PvP element, where players can attack each other.",getsetting("gamename","Legend of the Green Dragon"));
