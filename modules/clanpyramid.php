...
function clanpyramid_getmoduleinfo()
{
    $info = [
        ...
        "settings" => [
            ...
            "lastwinner" => "Guild name of last winner,int|",
            "owned1" => "Guild id that owns Pyramid 1,int|",
            "owned2" => "Guild id that owns Pyramid 2,int|",
            "owned3" => "Guild id that owns Pyramid 3,int|",
        ],
        "prefs" => [
