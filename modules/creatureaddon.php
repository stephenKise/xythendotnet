	...
	switch($hookname){
		case "creatureencounter":
			...
			if (get_module_objpref("creatures",  $args['creatureid'], "description")){
				output(get_module_objpref("creatures",  $args['creatureid'], "description"));
			}
		...
		case "battle-victory":
			...
			if ($session['user']['level'] < 15 && e_rand(1,100) <= get_module_setting("gemchance") && get_module_objpref("creatures",  $args['creatureid'], "gemmessage")) {
