...
function dwellings_getmoduleinfo() {
	...
	"delete"=>"What should be done when the owner of a dwelling is deleted?, enum,0,Delete the dwelling,1,Set dwelling-status to 'abandoned',2,Give the house to the first key owner,3,Give the wife/husband - requires marriage|0",	
	"delete2"=>"What should be done if it can't do the above option., enum,0,Delete the dwelling,1,Set dwelling-status to abandoned|0",
	...
	"playerlocation" => "Which city is the user in?, viewonly",
