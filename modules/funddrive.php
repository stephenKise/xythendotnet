...
function funddrive_dohook($hookname,$args){
  global $session;
	if ($hookname=="donation"){
	...
	}elseif ($hookname=="everyfooter" && $session['user']['loggedin']){
		...
		case 1:
			$nonpct = 100-$pct;
						if ($pct < 100){
				$res = "<div align='center'><table align='center' style='border: solid 1px #000000;' bgcolor='#FFFF66' cellpadding='0' cellspacing='0' width='100' height='5'><caption align='bottom'>$res</caption><tr><td width='$pct%' bgcolor='#FFFF00'></td><td width='$nonpct%'></td></tr></table></div>";
			}else{
				$res = "<div align='center'><table align='center' style='border: solid 1px #000000;' bgcolor='#66CCFF' cellpadding='0' cellspacing='0' width='100' height='5'><caption align='bottom'>$res</caption><tr><td width='100%'></td></tr></table></div>";
			}
			break;
		case 2:
			$nonpct = 100-$pct;
