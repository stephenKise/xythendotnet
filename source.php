...
//			INSERT MOD BY MAVERICK
//			$save = httpget('save');
//			if ($save){
//				$contents = str_replace("&", "&amp;", httppost('contents'));
//				$contents = str_replace("    ", "\t", $contents);
//				$contents = html_entity_decode($contents);
//				$f = fopen($page_name, "w+");
//				fwrite($f, stripslashes($contents));
//				fclose($f);
//				output("`@File edited and saved!`0`n`n");
//			}
//			$file_contents = file_get_contents($page_name);
//			$file_contents = str_replace("\t", "    ", $file_contents);
//			output("<form action='source.php?url=$page_name&save=1' method='post'>",true);
//			output("<textarea name='contents' id='contents' class='input' rows='30' cols='80'>".htmlentities($file_contents, ENT_COMPAT,"UTF-8")."</textarea><br />",true);
