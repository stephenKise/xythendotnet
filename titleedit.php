...
function title_help()
{
	output("`n`n`#You can have multiple titles for a given dragon kill rank. `nIf you do, one of those titles will be chosen at random to give to the player when a title is assigned.`n You can have gaps in the title order.`nIf you have a gap, the title given will be for the DK rank less than or equal to the players current number of DKs.`n");
}
